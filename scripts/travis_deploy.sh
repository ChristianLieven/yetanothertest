...
if [[ "${TRAVIS_PULL_REQUEST}" != "false" || "${TRAVIS_REPO_SLUG}" != "ChristianLieven/yetanothertest" ]]; then
...
echo "Your new report will be visible at https://ChristianLieven.github.io/yetanothertest in a moment."
